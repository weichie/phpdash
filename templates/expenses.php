	...
	<table class="table table-striped table-hover doc-table">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $cost['item']; ?></td>
				<td><?php echo $cost['description']; ?></td>
				<td>€ <?php echo money_format("%.2n", $cost['price']);?></td>
			...
			<div class="modal-body">
				<form class="form-horizontal" action="" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea type="text" rows="4" class="form-control" id="description" placeholder="Description" name="description" required></textarea>
						</div>
					</div><!-- ./form-group -->
					<div class="form-group">
